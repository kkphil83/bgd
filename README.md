...
```shell
kubectl apply -f https://raw.githubusercontent.com/kkphil83/bgd/main/manifests/applications/bgd-app.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/kkphil83/bgd/main/manifests/applicationsets/bgd-pr-appset.yaml
```
...
here](https://github.com/kkphil83/bgd/pulls) that has the `preview`
label.
